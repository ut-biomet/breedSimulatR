...
#'
#' @details This object is a named list containing 3 elements: \itemize{
#'   \item{\code{genotypes} (\code{data.frame}): }{ Genotypic data encoded in
#'   allele doses of 100 fictitious individuals with 3333 SNP markers. These
#'   individuals have 10 chromosomes of length 10^6 bases pairs.}
...
#'   \code{pos} and \code{SNPid}.} \item{\code{snpEffects} (\code{numeric}): }{
#'   "true" effects of the 3333 individuals' markers about a fictitious
